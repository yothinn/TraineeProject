...
exports.create = function (req, res) {
    ...
    newCategories.createby = req.user;
...
exports.update = function (req, res) {
    var updCategories = _.extend(req.data, req.body);
    updCategories.updated = new Date();
    updCategories.updateby = req.user;
    updCategories.save(function (err, data) {
        if (err) {
            return res.status(400).send({
                status: 400,
                message: errorHandler.getErrorMessage(err)
